...
public class DriveEncoderSimBotics1114Style extends Command {
	SimPID drivePID;
	SimPID steeringPID;
	double gyroP = 0;
	double gyroI = 0;
	...
	public DriveEncoderSimBotics1114Style(double driveTarget, double drivePower, double driveHeading) {
