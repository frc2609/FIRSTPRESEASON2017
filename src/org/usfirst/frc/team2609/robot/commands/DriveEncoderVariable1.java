...
public class DriveEncoderVariable1 extends Command {
	SimPID drivePIDLeft;
	...
	public DriveEncoderVariable1(double drivePower) {
    ...
    protected void initialize(){
        ...
        this.steeringPID.setDesiredValue(autonHeading1);
        this.drivePIDLeft.setDesiredValue(autonDistance1);
        this.drivePIDRight.setDesiredValue(autonDistance1);
