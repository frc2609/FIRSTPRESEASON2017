...
public class DriveEncoderVariable3 extends Command {
	SimPID drivePIDLeft;
	...
	public DriveEncoderVariable3(double drivePower) {
    ...
    protected void initialize(){
		...
		autonDistance3 = (double)SmartDashboard.getNumber("auton distance 2: ",0);
		autonHeading3 = (double)SmartDashboard.getNumber("auton heading 2: ",0);
    	steeringPID.resetPreviousVal();
    	drivePIDLeft.resetPreviousVal();
    	drivePIDRight.resetPreviousVal();
        this.steeringPID.setDesiredValue(autonHeading3);
        this.drivePIDLeft.setDesiredValue(autonDistance3);
        this.drivePIDRight.setDesiredValue(autonDistance3);
