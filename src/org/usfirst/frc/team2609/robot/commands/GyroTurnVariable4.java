...
public class GyroTurnVariable4 extends Command {
    ...
    public GyroTurnVariable4(double maxPower, double turnHeading) {
    ...
    protected void initialize() {
		...
		autonAngle = (double)SmartDashboard.getNumber("auton angle 4: ",0);
